...
public class NewJFrame extends javax.swing.JFrame {
    ...
    int p1won()
    {
        ...
        if(p1won[3]==1 && p1won[5]==1 && p1won[7]==1)
        {
            return 1;
        }
     ...
     int p2won()
    {
        ...
        if(p2won[3]==1 && p2won[5]==1 && p2won[7]==1)
        {
            return 1;
        }
    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(reset, javax.swing.GroupLayout.DEFAULT_SIZE, 69, Short.MAX_VALUE)
                .addGap(15, 15, 15))
        );
